 ...
 *
 * Return: A pointer which points to the newly-allocated buffer.
 */
char *create_buffer(char *file)
{
	char *buffer;
 ...
 * @fd: The file descriptor that has to be closed.
 */
void close_file(int fd)
{
	int c;
 ...
 * @argc: A number of arguments which are supplied to the program.
